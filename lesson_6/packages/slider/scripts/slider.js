...
let images = {
    ...
    setNextLeftImage() {
        ...
        const currSlide = this.slides[this.currentIdx];
        currSlide.classList.add('slide-right-left');
        currSlide.classList.remove('hidden-slide');
        setTimeout(() => currSlide.classList.remove('slide-right-left'), 500); 
    ...
    setNextRightImage() {
        ...
        const currSlide = this.slides[this.currentIdx];
        currSlide.classList.add('slide-left-right');
        currSlide.classList.remove('hidden-slide');
        setTimeout(() => currSlide.classList.remove('slide-left-right'), 500); 
